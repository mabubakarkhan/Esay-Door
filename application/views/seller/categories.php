				...
				<?php if ($content): ?>
			  		...
			  		<?php foreach ($content as $key => $que): ?>
						...
						<div class="v-box wear-box">
					  		...
					  		<div class="wear-head">
					  			<strong><?=$que['cat']['title']?> <!-- <em style="font-style: normal; font-size: 12px; font-weight: normal;">(<?=count($que['products'])?>)</em> --></strong>
					  			<a href="<?=BASEURL.'seller/single-category/'.$que['cat']['id'].'/'?>">All Products</a>
					  		</div>
