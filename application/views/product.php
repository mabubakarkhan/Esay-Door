					...
					<div class="d-box">
						...
						<div class="right-detail-box detail">
							<div class="top-box">
								...
								<ul class="share">
									<li><div class="fb-share-button" data-href="<?=$_SESSION['url']?>" data-layout="" data-size=""><a target="_blank" href="<?=$_SESSION['url']?>" class="fb-xfbml-parse-ignore">Share</a></div></li>
